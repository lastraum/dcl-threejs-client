...
**Status:** **v1.1.x** production beta ✅ (still not full Explorer parity). Multi-room chat + cast · nearby voice · **P4 bloom/HDR** · **glider** · backpack equip→world · **In-World Camera + Camera Reel gallery** · terrain editor biomes. **1.x next:** outfits/marketplace · scene UI text-measure · community voice Bearer (see [`PROGRESS.md`](./PROGRESS.md))  
