...
**Status:** **v1.0.0** core play loop production beta ✅ (still not full Explorer parity). Multi-room chat + cast · nearby voice · circular minimap. **1.x:** spatial voice · in-world `/goto` · DMs (see [`PROGRESS.md`](./PROGRESS.md))  
