...
> **Last updated:** 2026-06-18 (Lighting polish ✅ · Preferences panel ✅ · Scene emissives 🟡)  
> **Current phase:** **Phase 4 closed** — EntityStore + **AvatarAttach Tier B** + **TriggerArea Tier A** shipped. Next: merge `lastraum` → `dev-latest`, Raycast, e10 perf.
...
**Branch:** `lastraum` (13 commits ahead of `dev-latest` as of 2026-06-18 — merge pending)
