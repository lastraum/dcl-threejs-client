...
**Must fix before public:** GitHub raw URL + default branch in `tasksRegistry.ts` and AGENTS.md; `"private": true` in package.json; `.env.example`; expanded `.gitignore`; remove LastSlice sibling paths from IMPLEMENTATION_PLAN.md.
