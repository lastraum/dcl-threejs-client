...
| **Graphics post-FX stubs** | Preferences bloom/HDR/outline/distance still UI-only; **preset / shadows / scene lights / res scale / FPS / MSAA** are live. VSync hidden (browser rAF). Fullscreen stub. |
