...
import { isAvatarToonDisabled } from '../client/debug/ClientDebugLog'
 ...
 * t = (N·ray + 1)/2; thresholds 0.90/0.80/0.20 → multipliers 1.2/1.0/1.0/0.8.
 * The ×0.8 floor is why official interiors/seams never read as black voids the way
 * raw PBR shading does (e.g. the dark ring inside an open waistband).
 */
...
export function applyAvatarToonShading(root: THREE.Object3D): void {
  if (isAvatarToonDisabled()) return
  root.traverse((obj) => {
