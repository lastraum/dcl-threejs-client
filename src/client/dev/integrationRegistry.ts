...
export const CLIENT_UI_INTEGRATION: IntegrationEntry[] = [
  ...
  { id: 'ui:preferences-graphics', name: 'Preferences → Graphics', status: 'partial', category: 'client-ui', notes: 'Preset, shadows, scene lights, res scale, FPS, FOV, lighting live; MSAA/bloom/distance stubs' },
