...
export const CLIENT_UI_INTEGRATION: IntegrationEntry[] = [
  ...
  { id: 'ui:preferences-graphics', name: 'Preferences → Graphics', status: 'partial', category: 'client-ui', notes: 'Preset L/M/H/Custom, shadows, lights, res scale, FPS, MSAA, FOV, lighting live; VSync hidden; Resolution/Fullscreen stub; bloom/HDR prefs next (P4); distance stubs' },
...
export const PERFORMANCE_INTEGRATION: IntegrationEntry[] = [
  ...
  { id: 'perf:scene-emissives', name: 'Scene GLTF emissive LEDs', status: 'render', category: 'performance', notes: 'Property-based neon; untextured emissiveFactor → additive MeshBasic glow (muzzle/VFX); full bloom still open (P4)' },
