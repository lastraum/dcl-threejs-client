...
export const CLIENT_UI_INTEGRATION: IntegrationEntry[] = [
  ...
  { id: 'ui:preferences-graphics', name: 'Preferences → Graphics', status: 'partial', category: 'client-ui', notes: 'Preset, shadows, lights, res scale, FPS, MSAA, VSync, Fullscreen, FOV, lighting live; bloom/HDR/distance stubs' },
