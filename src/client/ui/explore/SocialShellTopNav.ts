...
/** Shared 2D shell nav — Explore · Map · Communities · Events · Marketplace · Loot Bag · Terrain + account chrome. */
  ...
  constructor(opts: SocialShellTopNavOptions) {
    ...
    this.el.innerHTML = `
      ...
      <nav class="social-shell-topnav__nav" aria-label="Main">
        ...
        <button type="button" class="social-shell-topnav__link social-shell-topnav__link--marketplace" data-shell-tab="marketplace">Marketplace</button>
