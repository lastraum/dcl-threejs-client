...
export const DCL_ECS_COMPONENTS: EcsComponentEntry[] = [
  ...
  { name: 'PhysicsCombinedForce', coreId: 1216, phase: 6, status: 'render', category: 'physics' },
  { name: 'PhysicsCombinedImpulse', coreId: 1215, phase: 6, status: 'render', category: 'physics' },
  ...
  { name: 'UiTransform', coreId: 1050, phase: 3, status: 'render', category: 'ui' },
  { name: 'UiText', coreId: 1052, phase: 3, status: 'render', category: 'ui' },
  { name: 'UiBackground', coreId: 1053, phase: 3, status: 'render', category: 'ui' },
  { name: 'UiCanvasInformation', coreId: 1054, phase: 3, status: 'client-only', category: 'ui' },
  { name: 'UiInput', coreId: 1093, phase: 3, status: 'render', category: 'ui' },
  { name: 'UiInputResult', coreId: 1095, phase: 3, status: 'client-only', category: 'ui' },
  { name: 'UiDropdown', coreId: 1094, phase: 3, status: 'render', category: 'ui' },
  ...
  { name: 'GltfNodeModifiers', coreId: 1099, phase: 6, status: 'render', category: 'render' },
  { name: 'NftShape', coreId: 1040, phase: 6, status: 'render', category: 'render' },
