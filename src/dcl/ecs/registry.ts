...
export const DCL_ECS_COMPONENTS: EcsComponentEntry[] = [
  ...
  { name: 'UiBackground', coreId: 1053, phase: 3, status: 'none', category: 'ui' },
  { name: 'UiCanvasInformation', coreId: 1054, phase: 3, status: 'client-only', category: 'ui' },
  { name: 'UiInput', coreId: 1093, phase: 3, status: 'none', category: 'ui' },
  { name: 'UiInputResult', coreId: 1095, phase: 3, status: 'client-only', category: 'ui' },
  { name: 'UiDropdown', coreId: 1094, phase: 3, status: 'none', category: 'ui' },
  { name: 'UiDropdownResult', coreId: 1096, phase: 3, status: 'client-only', category: 'ui' },
  { name: 'AudioSource', coreId: 1020, phase: 3, status: 'none', category: 'media' },
  { name: 'AudioStream', coreId: 1021, phase: 3, status: 'none', category: 'media' },
  { name: 'AudioEvent', coreId: 1105, phase: 3, status: 'client-only', category: 'media' },
