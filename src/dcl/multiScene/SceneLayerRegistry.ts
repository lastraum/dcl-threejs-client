/**
 * Phase A — every running scene is a layer (primary, PX, secondary).
 * Behavior-preserving registry; claim merge is Phase B.
...
export type SceneLayer = {
  ...
  priority: number
  /** PhysX entity id offset (PX / secondary namespaces). Primary = 0. */
  physOffset: number
}
 ...
 * World registers primary; PX/secondary managers register their slots.
 */
